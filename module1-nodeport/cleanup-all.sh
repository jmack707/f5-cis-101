...
kdelete lab2-ingress/02-nodeport-service-hello-world.yaml
kdelete lab2-ingress/01-deployment-hello-world.yaml
kdelete lab3-configmap-as3/03-configmap-hello-world.yaml
kdelete lab3-configmap-as3/02-nodeport-service-hello-world.yaml
kdelete lab3-configmap-as3/01-deployment-hello-world.yaml
kdelete lab1-install-cis/02-nodeport-deployment.yaml
echo "CIS + demos removed. (SA/RBAC/secret left — shared across modules.)"
